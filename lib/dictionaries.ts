...
const uk: Dictionary = {
  ...
  seo: {
    ...
    delivery: {
      ...
      description:
        'Доставка квітів по Одесі того ж дня — залежно від наявності квітів. Безкоштовно від 2 500 ₴, оплата картою або готівкою курʼєру.',
    },
    contact: {
...
const ru: Dictionary = {
  ...
  seo: {
    ...
    delivery: {
      ...
      description:
        'Доставка цветов по Одессе в день заказа — в зависимости от наличия цветов. Бесплатно от 2 500 ₴, оплата картой или наличными курьеру.',
    },
    contact: {
