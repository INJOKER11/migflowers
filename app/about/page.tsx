  ...
  return (
    <>
      <Section pt={44} pb={40}>
        ...
        >
          <p style={PARAGRAPH}>
            Марія відкрила крамницю на Соборній площі у 1998 році — розкладний столик і відро
            гвоздик. Ремеслу вона навчилася від власної матері, яка продавала квіти на цій самій
            площі ще до того, як війна змінила її призначення. Одинадцять років крамниця була
            однією жінкою й одним столиком.
          </p>
          <p style={PARAGRAPH}>
