  ...
  return (
    ...
    >
      <div style={{ animation: 'migRise .7s ease both' }}>
        ...
        >
          Олена і Сергій вирощують квіти в Одесі вже понад десять років — частину в наших теплицях,
          частину докуповують для композицій, яких потребує сезон. Кожен букет зрізають, напувають і
          звʼязують руками того самого дня, коли він їде до вас.
        </p>
